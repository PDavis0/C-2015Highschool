...
int main()
{
	/*	variable declarations
		...
		row,column					random plot to place ship
	...
	*/
	...
	do 
	{
		...
		for (k=0;k<5;k++)//loops each ship (carrier,battle...ding)
		{
			...
			if (ship[4]==0)
			{
				if (direction[4]==1)//north
				{
					for (i=0;i<5;i++) 
					{
						if(coordinates[row[4]][column[4]]==1 || check==0)
						{
							check=0;
						}
						else
			...
			if (ship[3]==0)
			{
				if (direction[3]==1)//north
				{
					for (i=0;i<4;i++) 
					{
						if(coordinates[row[3]][column[3]]==1 || check==0)
						{
							check=0;
						}
						else
			...
			*/
			...
			if (ship[2]==0)
			{
				if (direction[2]==1)//north
				{
					for (i=0;i<3;i++) 
					{
						if(coordinates[row[2]][column[2]]==1 || check==0)
						{
							check=0;
						}
						else
			...
			if (ship[1]==0)
			{
				if (direction[1]==1)//north
				{
					for (i=0;i<3;i++) 
					{
						if(coordinates[row[1]][column[1]]==1 || check==0)
						{
							check=0;
						}
						else
			...
			if (ship[0]==0)
			{
				if (direction[0]==1)//north
				{
					for (i=0;i<2;i++) 
					{
						if(coordinates[row[0]][column[0]]==1 || check==0)
						{
							check=0;
						}
						else
		...
		//void shipsearch (int arr[][], int row, int col, int length, int direction, int k, int &hope)
		/*for (j=0;j<5;j++)
		{
